...
if( isset($_GET['import_pack']) || isset($_POST['import_pack']) )
{
	...
	//
	$smile_pak = isset($_POST['smile_pak']) ? $_POST['smile_pak'] : (isset($_GET['smile_pak']) ? $_GET['smile_pak'] : '');
	$clear_current = isset($_POST['clear_current']) ? $_POST['clear_current'] : (isset($_GET['clear_current']) ? $_GET['clear_current'] : '');
	$replace_existing = isset($_POST['replace']) ? $_POST['replace'] : (isset($_GET['replace']) ? $_GET['replace'] : '');
...
{
	$export_pack = isset($_POST['export_pack']) ? $_POST['export_pack'] : $_GET['export_pack'];
