...
{
	case "addnew":
		$install_to = ( isset($_GET['install_to']) ) ? urldecode($_GET['install_to']) : ( isset($_POST['install_to']) ? $_POST['install_to'] : '' );
		$style_name = ( isset($_GET['style']) ) ? urldecode($_GET['style']) : ( isset($_POST['style']) ? $_POST['style'] : '' );
